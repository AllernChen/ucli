...
| GitHub 发布 | WINDOWS PASS / macOS 未发布：不可变标签 `v0.12.3` 指向 `e8045356a649690b0dfb2fcbbad5d949187f600f`；GitHub Actions run `33713768288` 于 2026-09-03 12:11（Asia/Shanghai）成功完成 Windows npm 11.16 干净安装、全量测试、构建、打包、产物校验、上传和发布。正式 Release 为 `https://github.com/AllernChen/ucli/releases/tag/v0.12.3`：Setup 134,254,240 bytes，SHA-256 `58CA91BBE420BABB7C3F88C398495FE4563ED136E22B1E951C5E78629F5C1BD4`；Portable 133,998,823 bytes，SHA-256 `9373928FA0AAEE99B689504B7BECF9583CE834521F5E6A87FA707A16C879540E`；blockmap 137,338 bytes，SHA-256 `4E63EBADA859D76A63A912A27A3BB2BD42866198A11E9C9D5C50EFE49687540F`；`latest.yml` 348 bytes，SHA-256 `CE1645871DAE4680713048809298AE8ECB5328A01719A8F3012E47B6E4110C6A`；`SHA256SUMS.txt` 365 bytes，SHA-256 `22DADF70BFB7640ABF10D9C45F5517E7771A8A7416A5F83940C926DEBB1BF682`。macOS 允许失败支线在全量测试中失败，未生成 DMG/ZIP；本记录不将其标为通过。发布任务另报告 `download-artifact` 的无效 `if-no-files-found` 输入警告，但实际 Windows 五项资产均已逐项核对为 uploaded。 |
