...
test('release package metadata is consistently versioned as 0.10.1', () => {
  assert.equal(packageJson.version, '0.10.1')
  assert.equal(packageLock.version, '0.10.1')
  assert.equal(packageLock.packages[''].version, '0.10.1')
})
