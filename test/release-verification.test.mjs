...
test('app release package and acceptance documentation agree', async () => {
  ...
  assert.equal(JSON.parse(packageSource).version, '0.12.3')
  ...
  assert.match(changelog, /## \[0\.12\.3\] - 2026-09-03/)
  assert.match(changelog, /同步服务档案/)
  assert.match(changelog, /Skills 页面.*同步组织目录/s)
  assert.match(changelog, /0\.12\.2.*未发布.*npm ci.*没有创建 GitHub Release/s)
  assert.match(acceptance, /## 0\. 0\.12\.3 发布证据/)
  assert.match(acceptance, /9d14d9b348a3fd7dd0301317ceb429f59e768a22/)
  assert.match(acceptance, /4425F8AC8DBD02434AC6FEB5806341FBB3DBAC2EE3633FC658B2082F4313E004/)
  assert.match(acceptance, /55C95A27D67664F187B9AAB1F09B5E7D0144938A659C0927630EB4D48264ACB5/)
  assert.match(acceptance, /33713768288/)
  assert.match(acceptance, /58CA91BBE420BABB7C3F88C398495FE4563ED136E22B1E951C5E78629F5C1BD4/)
  assert.match(acceptance, /9373928FA0AAEE99B689504B7BECF9583CE834521F5E6A87FA707A16C879540E/)
  assert.match(acceptance, /## 0\. 0\.12\.2 未发布候选证据/)
  assert.match(acceptance, /a936de78e0039a82a3d7e3c0588c114220fae4d6/)
  assert.match(acceptance, /60293FD360181D58AD5265A14239AF98358D4B1D7A7301DF89FBCA78193686D7/)
  assert.match(acceptance, /33712452896/)
  ...
  assert.match(acceptance, /24842A2A62C670715E4ECA61FD067C90063FA0DE2B52D56C1205B3CA20D35846/)
  assert.match(acceptance, /33529185806/)
  assert.match(acceptance, /F264951C61CC2A79FC1089D82A2FF653114954566694E3C8A1524C97EEA4B1C0/)
  assert.match(acceptance, /F1B5E72AC8E4A0C0128B0E63EF31CD1DCD34CECA4CB7C2CC47DC25BF8728C80A/)
