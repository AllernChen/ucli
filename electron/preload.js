...
const api = {
  ...
  previewSkillsBatchAction: (request) => ipcRenderer.invoke('skills:preview-batch-action', request),
  applySkillsBatchAction: (request) => ipcRenderer.invoke('skills:apply-batch-action', request),
  ...
  removePackage: (packageId) => ipcRenderer.invoke('skills:remove-package', packageId),
