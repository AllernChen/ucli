...
export function createDshBridgeEndpoint({
  ...
  // Unix socket paths are capped at ~107 chars (sun_path). macOS temp dirs are
  // long (/var/folders/xx/.../T), so a full 36-char UUID basename can overflow
